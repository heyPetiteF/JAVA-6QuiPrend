...
public class Background3 extends Application {
    private Label textLabel;
    private int counter = 0;
    private String[] lines = {"In each round, players choose a card from their hand",
            "and place it face down in front of them. When everyone is ready,",
            "players reveal their cards and place them in numerical",
            "order on the ends of the rows."};
    ...
    public void start(Stage primaryStage) {
        ...
        continueButton.setOnAction(e -> {
            new Background4().start(primaryStage);
            primaryStage.close();
        });
